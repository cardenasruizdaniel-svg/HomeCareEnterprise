...
def sembrar_manuales_existentes(usuario_id=None, usuario_nombre="Sistema"):
    ...
    manuales_iniciales = [
        ...
        ("Manual_Protocolo_Toma_Muestras_Supervision.docx", "Protocolo Operativo de Toma de Muestras y Lista de Supervisión", "Guía paso a paso (23 puntos) para tomar una muestra correctamente, y cómo Calidad la audita en sitio con la lista de supervisión digital.", "Operación", "Ambas", "Todos"),
        ...
        ("Manual_Gestion_Calidad_PQR_Portal_Web.docx", "Manual del Sistema de Gestión de Calidad, PQR/SIAU y Portal Web", "PAMEC, auditorías, hallazgos, riesgos, seguridad del paciente, PQR con radicado, y el portal web público conectado al sistema.", "Calidad y Normatividad", "Web", "Administrador,Coordinador"),
    ]
