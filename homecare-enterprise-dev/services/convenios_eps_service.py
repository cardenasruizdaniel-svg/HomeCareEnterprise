...
def asignar_convenio_paciente(paciente_id, convenio_id, fecha_ingreso, usuario_id, fecha_fin=None) -> int:
    if not convenio_id:
    ...
    # Si no se indica hasta cuándo queda autorizado este plan
    ...
    return ejecutar(
        "INSERT INTO paciente_convenio(paciente_id, convenio_id, fecha_ingreso, fecha_fin, usuario_creacion) VALUES (?, ?, ?, ?, ?)",
        (paciente_id, convenio_id, fecha_ingreso, fecha_fin, usuario_id),
    )
